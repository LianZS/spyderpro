...
class Road:
    ...
    def __init__(self, pid: int, roadname: str, speed: float, dircetion: str, bounds: dict, data: dict, num: int,rate:float):
        """
        Args:
            pid: INT 类型属性，城市标识
    ...
    def __str__(self):
        return "标识{0},路名：{1}，拥堵指数{2},方向：{3}，速度：{4}".format(self.region_id, self.roadname, self.rate,self.direction,
                                                                   self.speed)
