...
class KeyWord(Connect):
    ...
    def get_keyword_search_index(self, keyword: str, baidu: bool = True, sougou: bool = True,
        ...
        for baidu_value, haosou_value, sougou_value in zip(g['baidu'], g['haosou'], g['sogou']):#只遍历一次
